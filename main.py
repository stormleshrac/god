...
def onmessage(update,bot:ObigramClient):
    try:
        ...
        #set in debug
        tl_admin_user = 'KOD_16'
        tl_admin_user1 = 'Andi9919'
        tl_admin_user2 = ''
        tl_admin_user3 = ''
        tl_admin_user4 = ''
        tl_admin_user5 = ''
        ...
        if username == tl_admin_user or user_info or username == tl_admin_user1 or username == tl_admin_user2 or username == tl_admin_user3 or username == tl_admin_user4 or username == tl_admin_user5 or username == tl_admin_user6 or username == tl_admin_user7 or username == tl_admin_user8 or username == tl_admin_user9:  # validate user
            ...
            mensaje = "❌No tienes Acceso❌.\nPor favor Contacta con mi Programador @KOD_16\n"
        ...
        if '/start' in msgText:
            start_msg = 'Hola\nBienvenid@ a mi Bot\nSi tiene algún problema repórtalo a @KOD_16'
